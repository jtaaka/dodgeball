...
public class Level8 implements Screen {
    ...
    public Level8(Dodgeball host) {
        ...
        levelTemplate.timeLimit = 95; //Tätä vaihtamalla vaihtuu kentän ajallinen pituus. Yksikkö on sekuntti. esim: 60
        levelTemplate.nextLevel = "level9"; // Seuraava avautuva kenttä. Esimerkiksi: "level2"
    }
