...
public class Level10 implements Screen {
    ...
    int MAX_BALL_AMOUNT = 9; // Maksimi määrä palloja kentällä yhtäaikaa. esim: 10
    private Texture background;
    boolean whiteTimer = false;

    public Level10(Dodgeball host) {
        ...
        levelTemplate.timeLimit = 125; //Tätä vaihtamalla vaihtuu kentän ajallinen pituus. Yksikkö on sekuntti. esim: 60
        levelTemplate.nextLevel = "level11"; // Seuraava avautuva kenttä. Esimerkiksi: "level2"
    }
