...
public class Level7 implements Screen {
    ...
    int MAX_BALL_AMOUNT = 7; // Maksimi määrä palloja kentällä yhtäaikaa. esim: 10
    private Texture background;
    boolean whiteTimer = false;

    public Level7(Dodgeball host) {
        background = new Texture("sandbg.png");
        ...
        levelTemplate.timeLimit = 85; //Tätä vaihtamalla vaihtuu kentän ajallinen pituus. Yksikkö on sekuntti. esim: 60
        levelTemplate.nextLevel = "level8"; // Seuraava avautuva kenttä. Esimerkiksi: "level2"
    }
